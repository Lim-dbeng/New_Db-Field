...
<head>
	...
	<link rel="stylesheet" href="<%=request.getContextPath()%>/assets/css/custom.css?v=2">
...
감사합니다.</div>
		...
		<div id="projectManagementModal" class="project-management-modal" style="<%= isAdminMode ? "display: flex;" : "display: none;" %>">
			<div class="project-management-modal-content">
				<div class="project-management-modal-header">
					...
					<div class="project-management-header-actions d-flex align-items-center gap-2">
						<button type="button" class="btn btn-outline-secondary btn-sm admin-logout-btn" id="projectManagementLogoutBtn" style="<%= isAdminMode ? "" : "display: none;" %>">로그아웃</button>
						<button type="button" class="project-management-modal-close" id="projectManagementModalClose" style="<%= isAdminMode ? "display: none;" : "" %>">
							<iconify-icon icon="tabler:x"></iconify-icon>
						</button>
					</div>
				</div>
			...
			<div class="project-admin-modal-content" style="max-width: 520px;">
				...
				<div class="project-admin-modal-body">
					<form id="projectAddForm">
						<div class="mb-3">
							<label class="form-label">사업번호 <span class="text-danger">*</span></label>
							<input type="text" class="form-control" id="projectAddCode" placeholder="예: J2019126" maxlength="50" required>
						</div>
						<div class="mb-3">
						...
						<div class="mb-3">
							...
							<div class="position-relative" id="projectAddPmContainer">
								<input type="text" class="form-control" id="projectAddPmInput" placeholder="부서/사번/이름 검색 후 선택" autocomplete="off" readonly>
								<input type="hidden" id="projectAddPmId">
								<div id="projectAddPmDropdown" style="display: none; position: absolute; top: calc(100% + 4px); left: 0; width: 100%; background: white; border: 1px solid #e5e7eb; border-radius: 6px; box-shadow: 0 2px 8px rgba(0,0,0,0.08); z-index: 10090; max-height: 280px; overflow: hidden; box-sizing: border-box;">
									<input type="text" id="projectAddPmSearch" class="form-control form-control-sm" placeholder="부서/사번/이름 검색" autocomplete="off" style="border: none; border-bottom: 1px solid #e5e7eb; border-radius: 6px 6px 0 0; padding: 6px 10px; font-size: 13px; position: sticky; top: 0; background: white; z-index: 1; width: 100%; box-sizing: border-box;">
									<div id="projectAddPmOptions" style="max-height: 220px; overflow-y: auto;"></div>
								</div>
							</div>
						</div>
						<div class="row">
							<div class="col-6">
								<div class="mb-3">
									...
									<input type="date" class="form-control" id="projectAddStartDt" required>
								</div>
							</div>
							<div class="col-6">
								<div class="mb-3">
									<label class="form-label">종료일</label>
									<input type="date" class="form-control" id="projectAddEndDt">
								</div>
							</div>
						</div>
		...
		<aside class="sidebar">
			...
			<section id="shpUploadSection" class="panel fac-search-section" style="display:none;">
				...
				<div class="fac-search-filters mt-3">
					...
					<div class="form-group mt-3">
						<label class="form-label">파일 선택 (.geojson, .zip, .dxf, .dwg, .dgn) — 여러 개 선택 가능</label>
						<input type="file" id="shpFileInput" class="form-control form-control-sm" accept=".geojson,.json,.zip,.dxf,.dwg,.dgn" multiple>
					</div>
			...
			<section id="facSearchSection" class="panel fac-search-section" style="display:none;">
				...
				<div id="facSearchResults" class="fac-search-results mt-3">
					<div class="fac-search-results-header d-flex justify-content-between align-items-center">
	...
	<!-- 사업관리 -->
	<script src="<%=request.getContextPath()%>/assets/js/project-management.js?v=1"></script>
	...
	<script src="<%=request.getContextPath()%>/assets/js/facility.js?v=2"></script>
	<script src="<%=request.getContextPath()%>/assets/js/project-filter.js?v=2"></script>
	<script src="<%=request.getContextPath()%>/assets/js/facility-search.js?v=2"></script>
	<script src="<%=request.getContextPath()%>/assets/js/project-list.js?v=1"></script>
	...
	<script src="<%=request.getContextPath()%>/assets/js/shp-upload.js?v=1"></script>
	...
	<script src="<%=request.getContextPath()%>/assets/js/shp-panel.js?v=1"></script>
